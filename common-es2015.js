...
let VehicleService = class VehicleService {
    constructor(firestore, _httpClient) {
        this.firestore = firestore;
        this._httpClient = _httpClient;
    }
    create_NewVehicle(record) {
    ...
    sendSMS(msgDetails) {
        this._httpClient.get('https://api.msg91.com/api/sendhttp.php?mobiles=91' + msgDetails.mobile_no + '&authkey=258429At8ExWrCdC15c4c2a82&route=4&sender=SKDPRK&message=' + msgDetails.msg + '&country=91').subscribe((res) => {
            console.log(res);
            return res;
        });
