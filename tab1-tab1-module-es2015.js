...
let Tab1Page = class Tab1Page {
    constructor(_toastController, _angularFireStore, _angularFireAuth, _vehicleService, _alertController, _ng2ImgMax, router, loadingController, modalController, activityService, activatedRoute, formBuilder, printer) {
        ...
        this._vehicleService.read_cloudnary().subscribe(data => {
            this.cloudary = data.map(e => {
                return {
                    id: e.payload.doc.id,
            ...
            console.log("ssc", this.cloudary);
            this.uploader = new ng2_cloudinary__WEBPACK_IMPORTED_MODULE_9__["CloudinaryUploader"](new ng2_cloudinary__WEBPACK_IMPORTED_MODULE_9__["CloudinaryOptions"]({
                cloudName: this.cloudary[0]['cloud_name'],
                uploadPreset: this.cloudary[0]['upload_preset']
            }));
        });
    }
    printDetail() {
        ...
        var myvar = '<body class="mobileView" style=" font-family: \'Roboto\', sans-serif;margin: 0px;padding: 0px;">' +
            ...
            '    </div>' +
            '</body>';
        this.printer.print(myvar, options).then((value) => {
    ...
    getLatestValue() {
        ...
        this._angularFireStore
            ...
            console.log("id", typeof this.vehicleList[0].id);
            this.counter = parseInt(this.vehicleList[0].id) + 1;
        });
    ...
    addToVehicles() {
        const loaderToShow = this.loadingController.create({
        ...
        this.vehicleFormGroup.controls["id"].setValue(this.counter);
        let vehicleNo = this.vehicleFormGroup.value.vehicle_no;
        ...
        const parkingDetails = this.vehicleFormGroup.value;
        this._angularFireStore
            .collection("vehicles", (ref) => {
            ...
            if (res.length == 0) {
                this._vehicleService.create_NewVehicle(parkingDetails).then(() => {
                    ...
                    this.msgDetails = { mobile_no: parkingDetails.mobile, msg: "Dear " + parkingDetails.name + "! Your Vehicle " + parkingDetails.vehicle_no + " is parked with Sri Kanka Durga Parking Yard!!! For Queries call: 8886922228" };
                ...
                buttons: [
                    {
                        text: "Camera",
                        handler: () => {
                            this.cameraView.nativeElement.click();
                        }
                    },
                    {
                        text: "Gallery",
                        handler: () => {
                            this.imageView.nativeElement.click();
                        }
                    }
                ]
            });
    ...
    handleFileInput(files) {
        ...
        */
        ...
        this.uploader.onSuccessItem = (item, response, status, headers) => {
            ...
            const images = this.vehicleFormGroup.controls['images'];
