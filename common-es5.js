...
var VehicleService = /** @class */ (function () {
    function VehicleService(firestore, _httpClient) {
        this.firestore = firestore;
        this._httpClient = _httpClient;
    }
    VehicleService.prototype.create_NewVehicle = function (record) {
        console.log("record", record);
        return this.firestore.collection('vehicles').add(record);
    };
    VehicleService.prototype.read_Vehicles = function () {
        return this.firestore.collection('vehicles').snapshotChanges();
    };
    VehicleService.prototype.read_cloudnary = function () {
        return this.firestore.collection('cloudnary').snapshotChanges();
    };
    VehicleService.prototype.sendSMS = function (msgDetails) {
        this._httpClient.get('https://api.msg91.com/api/sendhttp.php?mobiles=91' + msgDetails.mobile_no + '&authkey=258429At8ExWrCdC15c4c2a82&route=4&sender=SKDPRK&message=' + msgDetails.msg + '&country=91').subscribe(function (res) {
            console.log(res);
            return res;
        });
        //return this._httpClient.get("https://api.msg91.com/api/sendhttp.php?mobiles=919966330990&authkey=258429At8ExWrCdC15c4c2a82&route=4&sender=TESTIN&message=SaiRam! This is a test message&country=91");
    };
    VehicleService.prototype.get_Vehicle = function (vehicle) {
        //  return this.firestore.collection('vehicles').where("name", "==", vehicle.name).get();
    };
