...
var Tab3Page = /** @class */ (function () {
    function Tab3Page(_angularFireStore, _angularFireAuth, _alertController, router, _vehicleService) {
    ...
    Tab3Page.prototype.gotoVehicle = function (vid) {
        console.log("vid", vid);
